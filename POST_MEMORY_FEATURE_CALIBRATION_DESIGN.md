...
and selects the best stage checkpoint by held-out validation mIoU. This commit
still requires a real PyTorch/checkpoint/data smoke on the execution server
before it can become the formal run SHA.
