...
| `EXP-003` | Query-Conditioned Leave-One-Out Support-Memory Selection | `IMPLEMENTED / DIAGNOSTIC_SMOKE_READY` | `PENDING`：frozen Stage A evaluator 与 host tests 已签名；仅授权 server `DIAGNOSTIC_ONLY` smoke，尚无 operator result 或 formal execution 授权。 | [`experiments/EXP-003.md`](experiments/EXP-003.md) | Accepted parent `000d450`; manifest `286fe46`; resolved contract SHA256 `462f410e46fae80ccc4f54d4b70b0fdc6f1fc272abefd40c9302629b57696a2d`; formal `89504a5dd379ecf4e807efd533a664910a2156c9`; execution config SHA256 `c7e453847261702ccb36c7d07b57fd2a2b5fe1a1c6946e51d3892c938360bd83` |
