...
| `EXP-003` | Query-Conditioned Leave-One-Out Support-Memory Selection | `FROZEN_RESEARCH_CONTRACT / MANIFEST_PENDING` | `PENDING`：Stage A 冻结 5-shot drop-one support-memory operator；exact episode manifest 尚待服务器生成和主机签名，未授权代码实现。 | [`experiments/EXP-003.md`](experiments/EXP-003.md) | Accepted parent `000d450`; contract SHA256 `fb244a41919c1c279b8ecd8e0ca473f57968a4172bf701357145e6af9f969cdf`; formal SHA `TBD` |
