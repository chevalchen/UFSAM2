...
| `EXP-002` | Repair-Benefit-Routed Mask Post-Correction | `FROZEN / IMPLEMENTATION_PENDING` | `PENDING`：Stage A 已冻结 fixed boundary-aware logit refiner 的 B0/B1/B8 headroom 合同；尚未实现或执行。 | [`experiments/EXP-002.md`](experiments/EXP-002.md) | Accepted parent `000d450`; contract SHA256 `d4c2b5b99b6f312cb0c8cc8345cd55bc6940416b3162598ab653a2f77e7040b2`; formal SHA `TBD` |
