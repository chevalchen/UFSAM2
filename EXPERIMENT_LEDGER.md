...
| `EXP-002` | Repair-Benefit-Routed Mask Post-Correction | `FROZEN / READY_FOR_EXPERIMENT_SESSION` | `PENDING`：Stage A fixed refiner 已实现并签名；服务器 smoke 与 formal training/evaluation 尚未执行。 | [`experiments/EXP-002.md`](experiments/EXP-002.md) | Accepted parent `000d450`; formal SHA `81773c27b7161f8bb99996ec180fb4aee826ff6f` |
