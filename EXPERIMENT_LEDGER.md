...
| `EXP-003` | Query-Conditioned Leave-One-Out Support-Memory Selection | `FROZEN_INPUTS / IMPLEMENTATION_READY` | `PENDING`：5-shot manifest 已完成 2400/2400 replay 并签名；Stage A operator/evaluator 尚未实现或执行。 | [`experiments/EXP-003.md`](experiments/EXP-003.md) | Accepted parent `000d450`; manifest `286fe46`; resolved contract SHA256 `462f410e46fae80ccc4f54d4b70b0fdc6f1fc272abefd40c9302629b57696a2d`; formal SHA `TBD` |
